...
//        if (userPostgreDAO.getUserByUserName(userName).equals(user)) return user;
...
//        if (userPostgreDAO.getUserByUserName(user.getUserName()) == null && userPostgreDAO.getUserByEmail(user.getEmail()) == null) {
//
//            userPostgreDAO.updateUserByName(userName, user);
//            return userPostgreDAO.getUserByUserName(user.getUserName());
//        }
